 ...
 */
router.post('/', authMiddleware, requireRole(UserRole.STUDENT, UserRole.DRIVER), createTrip);
 ...
 *         description: Viaje no encontrado
 */
router.delete('/:id', authMiddleware, cancelTrip);
 ...
 */
router.post('/:id/confirm', authMiddleware, requireRole(UserRole.DRIVER, UserRole.STUDENT), confirmPassenger);
 ...
 */
router.post('/:id/rating', authMiddleware, rateDriver);
