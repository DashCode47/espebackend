 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/code/:code', getCareerByCode);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put('/:careerId', updateCareer);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/campus/:campus', getCareersByCampus);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/modality/:modality', getCareersByModality);
