...
const likeUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield prisma.userInteraction.create({
            data: {
                user1Id: userId,
        ...
        const mutualMatch = yield prisma.userInteraction.findFirst({
            where: {
        ...
        if (mutualMatch) {
            match = yield prisma.connection.create({
                data: {
                    user1Id: userId,
                    user2Id: targetUserId
                },
...
const getMatches = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const mutualMatches = yield prisma.connection.findMany({
            where: {
                OR: [
                    { user1Id: userId },
                    { user2Id: userId }
...
const checkMatch = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const match = yield prisma.connection.findFirst({
            where: {
                OR: [
