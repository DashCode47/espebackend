 ...
 */
router.get('/category/:category', promotion_controller_1.getPromotionsByCategory);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/:promotionId', promotion_controller_1.getPromotion);
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.post('/', promotion_controller_1.createPromotion);
/**
 * @swagger
 * /api/promotions/{promotionId}:
 *   put:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.put('/:promotionId', promotion_controller_1.updatePromotion);
/**
 * @swagger
 * /api/promotions/{promotionId}:
 *   delete:
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.delete('/:promotionId', promotion_controller_1.deletePromotion);
